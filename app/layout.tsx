...
const description =
  "Kautum Krishnan Panjalaraja — data analyst, MSc Data Science at King's College London. My story told in charts I drew myself, including the one where my dissertation found an entire field was marking its own homework.";
